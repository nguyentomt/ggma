  ...
  return (
    <section id="contact">
      <div className="h-[vh80] py-8 flex flex-col items-center text-center">
        <h1 className="text-2xl md:text-3xl">Please come visit us at:</h1>

        <p>10141 Lampson Ave, Garden Grove CA 92840</p>

        <h1 className="text-2xl md:text-3xl">Call or email to schedule a tour:</h1>

        <p>
          <a href="tel:7146366300">📞 (714) 636 - 6300</a>
        </p>

        <p className="flex flex-row gap-1">
          
          <div className="tooltip hover:cursor-pointer" onClick={copyEmail}
              onMouseOut={outFunc}>
            <span className="tooltiptext" id="myToolTip">
              Copy to clipboard
            </span>
            💻 ggmontessori@gmail.com
          </div>
        </p>
      ...
      <div>
        <div className="flex gap-8 justify-center p-4">
          ...
          <a href="https://maps.app.goo.gl/KQtjpUSpny6GFA7K9" target="_new">
            <svg
              xmlns="http://www.w3.org/2000/svg"
